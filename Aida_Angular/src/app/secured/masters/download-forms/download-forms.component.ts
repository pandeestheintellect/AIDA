...
export class DownloadFormsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(params => {
      ...
      if (serviceCode==='secretarial-common')
        id=0;
      else if (serviceCode==='agreements')
        id=1;
      else if (serviceCode==='post-registration')
        id=2;
      else if (serviceCode==='share-capital')
        id=3;
      else if (serviceCode==='strike-0ff')
        id=4;
