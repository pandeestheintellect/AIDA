...
@Component({
  selector: 'app-officers-detail',
  templateUrl: './officers-detail.component.html',
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS}
  ]
})
export class OfficersDetailComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<OfficersDetailComponent>,
