...
@Component({
  selector: 'app-managing-directors-detail',
  templateUrl: './managing-directors-detail.component.html',
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS}
  ]
})
export class ManagingDirectorsDetailComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ManagingDirectorsDetailComponent>,
