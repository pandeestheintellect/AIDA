...
@Component({
  selector: 'app-secretaries-detail',
  templateUrl: './secretaries-detail.component.html',
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS}
  ]
})
export class SecretariesDetailComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<SecretariesDetailComponent>,
